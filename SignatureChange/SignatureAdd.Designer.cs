...
namespace SignatureChange {
    ...
    public sealed partial class SignatureAdd : Microsoft.Office.Tools.Outlook.OutlookAddInBase {
        ...
        public SignatureAdd(global::Microsoft.Office.Tools.Outlook.Factory factory, global::System.IServiceProvider serviceProvider) : 
    ...
    internal sealed partial class Globals {
        ...
        private static SignatureAdd _SignatureAdd;
        ...
        internal static SignatureAdd SignatureAdd {
            get {
                return _SignatureAdd;
            }
            set {
                if ((_SignatureAdd == null)) {
                    _SignatureAdd = value;
                }
                else {
        ...
        internal static ThisFormRegionCollection FormRegions {
            get {
                if ((_ThisFormRegionCollection == null)) {
                    _ThisFormRegionCollection = new ThisFormRegionCollection(Globals.SignatureAdd.GetFormRegions());
                }
    ...
    internal sealed partial class ThisFormRegionCollection : Microsoft.Office.Tools.Outlook.FormRegionCollectionBase {
        ...
        internal WindowFormRegionCollection this[Microsoft.Office.Interop.Outlook.Explorer explorer] {
            get {
                return ((WindowFormRegionCollection)(Globals.SignatureAdd.GetFormRegions(explorer, typeof(WindowFormRegionCollection))));
            }
        }
        
        internal WindowFormRegionCollection this[Microsoft.Office.Interop.Outlook.Inspector inspector] {
            get {
                return ((WindowFormRegionCollection)(Globals.SignatureAdd.GetFormRegions(inspector, typeof(WindowFormRegionCollection))));
            }
        }
    }
